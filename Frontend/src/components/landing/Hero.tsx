        ...
        <div className="flex-1 flex flex-col gap-md z-10 text-center md:text-left">
          <h1 className="font-display text-display text-on-surface leading-tight">
            ...
            <span className="text-primary relative inline-block">
              ...
              <svg className="absolute w-full h-3 -bottom-1 left-0 text-primary-container" preserveAspectRatio="none" viewBox="0 0 100 10">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-6/7 mx-auto md:mx-0">
            Never miss an episode. Sync your MyAnimeList account and receive hourly updates, breaking anime news, release alerts, and AI-powered summaries—all for free.
          </p>

          <form className="flex flex-col sm:flex-row gap-sm mt-sm w-full max-w-md mx-auto md:mx-0" onSubmit={(e) => e.preventDefault()}>
